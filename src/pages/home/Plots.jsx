  ...
  return (
    <>
      <div className={Styles.home}>
        <img
          src="https://c.housingcdn.com/demand/s/common/assets/defaultBannerPlot.c2e0fa53.jpg"
          alt="img"
        />
      </div>
      <section className={Styles.home_content}>
        ...
        <div className={Styles.formBox}>
          <p className={Styles.linkText}>
            ...
            {/* <span className={(window.location.href = "/pg") ? Styles.underline : ""}> */}
            <span
              className={(window.location.href = "/pg") ? Styles.underline : ""}
            >
